...
/*
 *  NOTE: original PW has 128-byte programming unit.
 *  ie writes must be 128-byte aligned and length must be a multiple of 128-bytes
 *  Erase units are 4x1k, 1x28k, 1x16k. Weird blocks
 */
